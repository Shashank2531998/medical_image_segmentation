...
from src.model.sat.transformer_decoder import TransformerDecoder,TransformerDecoderLayer
...
class Maskformer(nn.Module):
    def __init__(self, vision_backbone='UNET', image_size=[288, 288, 96], patch_size=[32, 32, 32], deep_supervision=False):
        ...
        if vision_backbone=='SwinUNETR':
            from src.model.sat.SwinUNETR import SwinUNETR
        ...
        if vision_backbone=='UMamba':
            from src.model.sat.umamba_mid import UMambaMid
